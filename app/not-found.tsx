  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-5 bg-page px-6 text-center">
      <svg width="220" height="120" viewBox="0 0 220 120" aria-hidden>
        <path d="M0 110 L45 45 L80 90 L115 30 L160 110 Z" fill="#d6e9dd" />
        <path d="M90 110 L135 55 L170 85 L200 40 L220 110 Z" fill="#a9d8bb" />
      ...
      <div className="flex gap-3">
        ...
        <a href="mailto:support@posttrain.example" className="btn-subtle">
          Support
        </a>
      </div>
    </main>
