...
const PATHS: Record<string, React.ReactNode> = {
  ...
  globe: (
    <path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM3.6 9h16.8M3.6 15h16.8M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18" />
  ),
  graduationCap: <path d="M22 9 12 4 2 9l10 5 10-5ZM6 11.5V16c2 2 10 2 12 0v-4.5M22 9v6" />,
  translate: <path d="M4 5h7M7.5 3v2M10 5c-.8 3.2-2.8 5.9-6 8M5 9c1 1.5 2.4 2.7 4 3.5M14 21l4-10 4 10M15.2 18h5.6" />,
  cube: <path d="m12 2 8 4.5v9L12 20l-8-4.5v-9L12 2ZM4 6.5l8 4.5 8-4.5M12 11v9" />,
  users: (
  ...
  star: <path d="m12 2 3.1 6.3 6.9 1-5 4.9 1.2 6.8L12 17.8l-6.2 3.2L7 14.2l-5-4.9 6.9-1L12 2Z" />,
  ...
  wrench: (
    <path d="M14.7 6.3a4.5 4.5 0 0 0-5.4 5.4L3.8 17.2a2.1 2.1 0 1 0 3 3l5.5-5.5a4.5 4.5 0 0 0 5.4-5.4l-3 3-2.4-2.4 3-3Z" />
  ),
  ...
  heart: (
    <path d="M20.8 8.6a4.6 4.6 0 0 0-8-3.1l-.8.86-.8-.86a4.6 4.6 0 0 0-8 3.1c0 2 1.1 3.9 2.9 5.6L12 21l6.9-6.8c1.8-1.7 2.9-3.6 2.9-5.6Z" />
  ),
  comment: <path d="M21 11.5a8.5 8.5 0 0 1-8.5 8.5H4l1.6-4.2A8.5 8.5 0 1 1 21 11.5Z" />,
  share: (
    <path d="M18 8a3 3 0 1 0-2.8-4H15a3 3 0 0 0 .1 1.3L8.9 8.7a3 3 0 1 0 0 6.6l6.2 3.4A3 3 0 1 0 18 16a3 3 0 0 0-2.1.9L9.7 13.5a3 3 0 0 0 0-3l6.2-3.4c.5.55 1.25.9 2.1.9Z" />
  ),
